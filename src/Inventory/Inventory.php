...
class Inventory
{
    ...
    public static function cronInfo($name)
    {
        switch ($name) {
            case 'cleantemp':
                return ['description' => __('Clean temporary files created from inventories'),'itemtype' => __('Inventory')];

            case 'cleanorphans':
                return ['description' => __('Clean inventories orphaned files'),'itemtype' => __('Inventory')];
        }
        return [];
    }
    ...
    {
        // return __("Inventory");
        return _n('Inventory', 'Inventories', $nb);
    }
