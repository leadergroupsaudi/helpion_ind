...
final class DataDirectoriesProtectedPath extends AbstractRequirement
{
    ...
    public function __construct(
        ...
        parent::__construct(
            ...
            __('Helpion data directories should be placed outside web root directory. It can be achieved by redefining corresponding constants. See installation documentation for more details.'),
            true,
            true
        );
    ...
    protected function check()
    {
        ...
        if (count($missing_directories) === 0 && count($unsafe_directories) === 0) {
            $this->validated = true;
            $this->validation_messages[] = __('Helpion data directories are located in a secured path.');
        } else {
