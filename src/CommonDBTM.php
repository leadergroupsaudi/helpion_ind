...
class CommonDBTM extends CommonGLPI
{
    ...
    public function addMessageOnAddAction()
    {
        ...
        if ($addMessAfterRedirect) {
            ...
            if ($this->getTypeName(1) == "Tickets" || $this->getTypeName(1) == "Ticket") {
                Session::addMessageAfterRedirect(stripslashes($display) . " created successfully. Thank you for using Helpion"
                );
