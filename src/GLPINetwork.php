...
class GLPINetwork extends CommonGLPI
{
    ...
    public static function showForConfig()
    {
        ...
        if ($registration_key === "") {
            ...
            __('A registration key is needed to use advanced feature (like marketplace) in Helpion') . "<br><br>" .
            "<a href='" . GLPI_NETWORK_SERVICES . "'>" . sprintf(__('Register on %1$s!'), 'Helpion Network') . "</a><br>" .
        ...
        if (!self::isServicesAvailable($curl_error)) {
            ...
            echo sprintf(__('%1$s services website seems not available from your network or offline'), 'Helpion Network');
            if ($curl_error !== null) {
                echo '<br />';
    ...
    /**
     * Get GLPI User Agent in expected format from Helpion Network services.
     *
     * @return string
     */
    public static function getGlpiUserAgent(): string
    {
        ...
        return sprintf('Helpion/%s (%s)', $version, $comments);
    }

    /**
     * Get Helpion Network UID to pass in requests to Helpion Network Services.
     *
     * @return string
     */
    ...
    /**
     * Get Helpion Network registration key.
     *
    ...
    /**
     * Get Helpion Network registration information.
     *
    ...
    /**
     * Check if Helpion Network registration is existing and valid.
     *
     * @return boolean
     */
    ...
    public static function showInstallMessage()
    {
        return nl2br(
            sprintf(
                __(
                    "You need help to integrate Helpion in your IT, have a bug fixed or benefit from pre-configured rules or dictionaries?\n\n"
                    . "We provide the %s space for you.\n"
                    . "Helpion-Network is a commercial service that includes a subscription for tier 3 support, ensuring the correction of bugs encountered with a commitment time.\n\n"
                    . "In this same space, you will be able to contact an official partner to help you with your Helpion integration."
                ),
    ...
    public static function getSupportPromoteMessage()
    {
        return nl2br(sprintf(
            __("Having troubles setting up an advanced Helpion module?\n" .
