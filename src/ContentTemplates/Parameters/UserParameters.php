...
class UserParameters extends AbstractParameters
{
    ...
    public function getAvailableParameters(): array
    {
        return [
            ...
            new AttributeParameter("phone2", __('Extension')),
            ...
            new ObjectParameter(new UserDepartmentParameters()),
    ...
    protected function defineValues(CommonDBTM $user): array
    {
       ...
       // Add userdepartment
        if ($userdepartment = UserDepartment::getById($fields['userdepartments_id'])) {
            $userdepartment_parameters = new UserDepartmentParameters();
            $values['userdepartment'] = $userdepartment_parameters->getValues($userdepartment);
        }
       // Add assets
        $values['used_items'] = [];
