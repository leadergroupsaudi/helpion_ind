...
class AuthLDAP extends CommonDBTM
{
   ...
   //connection caching stuff
    ...
    public function preconfig($type)
    {
        ...
        switch ($type) {
            ...
            case 'OpenLDAP':
                ...
                $this->fields['department_field']            = 'businessdepartment';
           ...
           //Fill fields when using preconfiguration models
            if (!$ID) {
                $hidden_fields = ['comment_field', 'email1_field', 'email2_field',
                    ...
                    'category_field','department_field', 'language_field', 'location_field',
    ...
    public function showFormUserConfig()
    {
        ...
        echo "<tr class='tab_bg_2'><td>" . _n('Department', 'Departments', 1) . "</td>";
        echo "<td><input type='text' class='form-control' name='department_field' value='" .
                 $this->fields["department_field"] . "'></td></tr>";
    ...
    public static function getSyncFields(array $authtype_array)
    {
        ...
        $fields = ['login_field'               => 'name',
            ...
            'department_field'            => 'userdepartments_id',
