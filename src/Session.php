...
class Session
{
    ...
    public static function checkCSRF($data)
    {
        ...
        $message = __("Your request could not be processed due to security reasons. Please refresh the page and try again.");
        if (
    ...
    public static function validateIDOR(array $data = []): bool
    {
        ...
        if (
            ...
            $data['_idor_token'] = Session::getNewIDORToken($data['itemtype'] ?? '');
            return self::validateIDOR($data);
        }
