   ...
   // permit writing to $_SESSION
    ...
    protected function lostPassword($params = [])
    {
        ...
        if (!isset($params['password_forget_token'])) {
            ...
            return [
                __('If the given email address match an exisiting Helpion user, you will receive an email containing the informations required to reset your password. Please contact your administrator if you do not receive any email.')
            ];
        } else {
