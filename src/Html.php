...
HTML;
     ...
     * @since 9.1
     * @param boolean $withVersion include Helpion version ?
     * @return string HTML copyright
     */
    public static function getCopyrightMessage($withVersion = true)
    {
        $message = "<a href=\"https://helpion.com/\" target=\"_blank\" title=\"Powered by Teclib and contributors\" class=\"copyright\">";
        $message .= "Helpion - Helpdesk";
