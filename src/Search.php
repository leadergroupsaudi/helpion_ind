        ...
        switch ($type) {
            ...
            case self::SYLK_OUTPUT: // Sylk
               ...
               // entetes HTTP
                ...
                header("Content-disposition: filename=helpion.slk");
            ...
            case self::CSV_OUTPUT: // csv
                ...
                header('Pragma: private'); /// IE BUG + SSL
                header('Cache-control: private, must-revalidate'); /// IE BUG + SSL
                header("Content-disposition: filename=helpion.csv");
            ...
            case self::NAMES_OUTPUT:
                header("Content-disposition: filename=helpion.txt");
